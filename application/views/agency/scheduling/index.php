          ...
          <table class="table datatable-basic dataTable no-footer" id="main-datatable">
            ...
            <tbody>
                ...
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>
                        <div class="dropdown-menu dropdown-menu-right" x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-158px, -116px, 0px);"> <a href="<?php echo site_url("agency/scheduling/view_scheduling"); ?>" class="dropdown-item"><i class="icon-menu7"></i>View Schedule</a> </div>
                      </div>
                    </div>
                  </div></td>
              </tr>
              ...
              <!--<tr>
                ...
                <td><span><strong style="font-weight: 400;">500</strong></span></td>
                <td><li class="media" style="list-style: none;">
                    <div class="mr-3"> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face17.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face18.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> </div>
                  </li></td>
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>
              ...
              <tr>
                ...
                <td><span><strong style="font-weight: 400;">500</strong></span></td>
                <td><li class="media" style="list-style: none;">
                    <div class="mr-3"> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face19.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face20.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> </div>
                  </li></td>
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>
              ...
              <tr>
                ...
                <td><span><strong style="font-weight: 400;">500</strong></span></td>
                <td><li class="media" style="list-style: none;">
                    <div class="mr-3"> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face22.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face24.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> </div>
                  </li></td>
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>
              ...
              <tr>
                ...
                <td><span><strong style="font-weight: 400;">500</strong></span></td>
                <td><li class="media" style="list-style: none;">
                    <div class="mr-3"> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face25.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face23.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> </div>
                  </li></td>
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>
              ...
              <tr>
                ...
                <td><span><strong style="font-weight: 400;">500</strong></span></td>
                <td><li class="media" style="list-style: none;">
                    <div class="mr-3"> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face14.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> <a href="#"> <img src="<?php echo base_url(); ?>assets/images/userimg/face13.jpg" class="rounded-circle" width="40" height="40" alt=""> </a> </div>
                  </li></td>
                <td class="text-center"><div class="align-self-center ml-3">
                    <div class="list-icons">
                      <div class="list-icons-item dropdown"> <a href="#" class="list-icons-item dropdown-toggle caret-0" data-toggle="dropdown" aria-expanded="true"><i class="icon-menu9"></i></a>

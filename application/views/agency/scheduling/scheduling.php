          ...
          <div class="row">
            <div class="col-md-12">
              <div class="row" style="text-align: center;">
                <div class="col-md-12">
                    <strong>Assign both schedule respectively</strong>
                </div>
              </div>
              <div class="row" style="margin-top: 10px; padding: 10px;">
                ...
                <div class="offset-md-4 col-md-4">
                  ...
                  <!-- <button type="button" class="btn bg-teal-400"><b></b> Mr Ronald Ross </button>
                  <button type="button" class="btn bg-teal-400"><b><i class="icon-reading"></i></b> Mrs Reggie Ross </button>
                  <button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left rounded-round legitRipple"><b><i class="icon-reading"></i></b> Rounded</button> -->
                </div>
              </div>
            </div>
          </div>
          <div class="tab-content">
            <div class="tab-pane fade show active" id="james1">
              <div class="navbar navbar-expand-xl navbar-light navbar-component rounded-top mb-0">
                <div class="navbar-brand d-xl-none"> <a href="index.html" class="d-inline-block"> <img src="<?php echo base_url(); ?>assets/images/logo_dark.png" alt=""> </a> 
                </div>
                <div class="d-xl-none">
            ...
            <div class="tab-pane fade" id="james2">
              <div class="navbar navbar-expand-xl navbar-light navbar-component rounded-top mb-0">
                <div class="navbar-brand d-xl-none"> <a href="index.html" class="d-inline-block"> <img src="<?php echo base_url(); ?>assets/images/logo_dark.png" alt=""> </a> 
                </div>
                <div class="d-xl-none">

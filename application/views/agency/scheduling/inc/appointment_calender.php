...
<div class="row">
  <div class="col-md-12">
    <div class="row">
      <div class="col-md-12" style="text-align: center;"> <a href="javascript:;" data-toggle="modal" data-target="#modal_new_appointment">Create new appointment
    ...
    <div class="row">
      <div class="col-md-12">
        <table class="table datatable-basic" id="appointment_datatable_1">
          ...
          <tbody>
            <tr>
              <td>Doctor's appointment<br>
                <span class="text-muted">Dr. Marvin Cobler</span></td>
              ...
              <td class="text-center"><div class="list-icons">
                  <div class="dropdown"> <a href="#" class="list-icons-item" data-toggle="dropdown"> <i class="icon-menu9"></i> </a>
                    <div class="dropdown-menu dropdown-menu-right"> <a href="#" class="dropdown-item"><i class="icon-square-right"></i> Edit Appointment</a> <a href="#" class="dropdown-item"><i class="icon-bin2"></i> Delete Appointment</a> <a href="#" class="dropdown-item"><i class="icon-square-down"></i> End Appointment</a> </div>
                  </div>
                </div></td>
            </tr>
          </tbody>

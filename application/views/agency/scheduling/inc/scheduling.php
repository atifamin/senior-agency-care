<div class="row">
  <div class="col-md-12">
    ...
    <div class="row" style="margin-top: 40px;">
      <div class="col-md-4"> <a href="javascript:;" onclick="assignCaregiver()">
	        ...
	        <div class="modal-body">
	          <div class="row">
	            <div class="col-md-8 offset-md-2">
	              <div class="form-group">
	                <strong>Assign caregiver to client schedule</strong>
	          ...
	          <div class="row">
	            <div class="col-md-8 offset-md-2">
	              <div class="form-group">
	              	<i class="icon-calendar22" style="margin-right: 5px;"></i>
	                <strong>Enter appointment date and time: </strong>
	                <div class="input-group">
	                	<div class="input-group">
							<input type="text" class="form-control daterange-single" value="03/18/2013">
						</div>
	          ...
	          <div class="row" style="text-align: center; padding-bottom: 5px;">
	            <div class="col-md-12">
	            	<strong>Assign time to schedule</strong>
	            </div>
	          </div>
	          <div class="row">
	          	<div class="col-md-6">
	            ...
	            <div class="col-md-8 offset-md-2">
	              <div class="form-group pt-2">
	                <div class="form-check">
	                  ...
	                  <strong style="margin-left: 10px;">Set this schedule as running</strong>
	                </div>
	              </div>
	            </div>
			</div>

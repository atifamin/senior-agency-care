      ...
      <tr>
        ...
        <td class="text-center"><div class="list-icons">
            <div class="dropdown"> <a href="#" class="list-icons-item" data-toggle="dropdown"> <i class="icon-menu9"></i> </a>
              <div class="dropdown-menu dropdown-menu-right"> <a href="javascript:;" onclick="edit_medication(<?php echo $value->id; ?>)" class="dropdown-item"><i class="icon-square-right"></i> Edit Medication</a> <a href="<?php echo base_url('agency/scheduling/delete_medication/'.$value->id.''); ?>" class="dropdown-item"><i class="icon-bin2"></i> Delete Medication</a> <a href="#" class="dropdown-item"><i class="icon-square-down"></i> End Medication</a> <a href="#" class="dropdown-item"><i class="icon-file-pdf"></i> Export to .pdf</a> </div>
            </div>
          </div></td>
      </tr>
      <?php }

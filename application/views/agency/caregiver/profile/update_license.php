<div class="row" id="row_<?php echo $id; ?>" style="margin-top:52px;">
  <div class="col-md-8">
    <div class="row">
  ...
  <div class="col-md-4 text-center">
    <div class="btn-group ml-1">
      ...
      <div class="dropdown-menu dropdown-menu-right"> <a href="javascript:;" class="dropdown-item" data-toggle="modal" data-target="modal_edit_license" onclick="edit_license('<?php echo $id; ?>')"><i class="icon-database-edit2"></i> Edit</a> <a href="javascript:;" class="dropdown-item" onclick="delete_license('<?php echo $id; ?>')"><i class="icon-bin2"></i> Delete</a> </div>
    </div>
  </div>
</div>

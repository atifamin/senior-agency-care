...
<div class="row">
	<div class="col-md-12">
		<div class="alert alert-warning alert-dismissible" style="padding: 5px !important;">You have not linked your bank account. You need to link your bank account to recieve and send funds.<a style="margin-left: 10px;" href="javascript:;" onclick="alert()" class="alert-link">Link your bank account here!</a>
	    </div>
	</div>
</div>
<div class="row">
	<div class="col-md-12">
		<div class="card">
			<div class="card-body" style="text-align: center;">
				<strong>Set Invoicing periods to:</strong><button style="margin-left: 10px;" type="button" class="btn btn-light legitRipple">Weekly <i style="margin-left: 5px;" class="icon-arrow-down22"></i></button>
			</div>
		</div>
	</div>
</div>

				...
				<div class="card-body">
					<div class="row">
						<div class="col">
							...
							<a href="<?php echo site_url("caregiver/payroll/archive");?>" class="btn bg-purple-300 btn-block btn-float"><i class="icon-archive icon-2x"></i>
								<span>Archive</span></a>
						</div>
						
						<div class="col">
							<a href="<?php echo site_url("caregiver/payroll/statistics"); ?>" class="btn bg-warning-400 btn-block btn-float"><i class="icon-stats-bars icon-2x"></i>

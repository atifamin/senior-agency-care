<?php
$report_detail = $this->common_model->listingResultWhere('client_id',$detail->client_id,"client_vital_reports");
//print_array($detail);
?>

<?php //print_array($client);?>
<div class="datatable-scroll">
  <table class="table" id="main-datatable_1_<?php echo $detail->id; ?>">
      <thead>
        <tr>
...
$("#main-datatable_1_<?php echo $detail->id; ?>").DataTable({
  autoWidth: false,
  columnDefs: [{ 
    orderable: false,
    width: 100,

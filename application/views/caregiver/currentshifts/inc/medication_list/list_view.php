<?php
$medication_detail = $this->common_model->listingResultWhere('client_id',$detail->client_id,"client_medication_list");
//print_array($medication_detail);
?>
<?php //print_array($client); ?>
<div class="datatable-scroll">
  <table class="table" id="main-datatable-<?php echo $detail->id; ?>">
    <thead>
      <tr>
        <th>Medication</th>
...
$("#main-datatable-<?php echo $detail->id; ?>").DataTable({
	autoWidth: false,
	columnDefs: [{ 
		orderable: false,
		width: 100,

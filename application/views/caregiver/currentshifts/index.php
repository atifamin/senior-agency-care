    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="media-list media-list-linked">
          ...
          <li>
            <div class="media">
              <div class="media-body"> <span class="text-muted">10:30am - 12:30pm</span> 
              ...
              <div class="align-self-center ml-3"> <a href="#" class="text-default" data-toggle="collapse" data-target="#james2"> <i class="icon-menu7"></i> </a> </div>
            </div>
                ...
                <div class="navbar navbar-expand-xl navbar-light navbar-component rounded-top mb-0">
                  ...
                  <div class="navbar-collapse collapse" id="navbar-demo-light">
                    <ul class="nav navbar-nav">
                      <li class="nav-item dropdown"> <a href="#client_bio" class="sub_car_pane navbar-nav-link active" data-toggle="tab"> <i class="icon-calendar3 mr-2"></i> Client Bio </a> </li>
                      ...
                      <li class="nav-item dropdown"> <a href="#diet_and_allergies" class="sub_car_pane navbar-nav-link" data-toggle="tab"> <i class="icon-collaboration mr-2"></i> Dietry and Allergies </a> </li>
                      <li class="nav-item dropdown"> <a href="#appiontment_callender" class="sub_car_pane navbar-nav-link" data-toggle="tab"> <i class="icon-users4 mr-2"></i> Appointment Calender </a> </li>
                      <li class="nav-item dropdown"> <a href="#client_vitals" class="sub_car_pane navbar-nav-link" data-toggle="tab"> <i class="icon-collaboration mr-2"></i> Client Vitals </a> </li>
                      ...
                      <li class="nav-item dropdown"> <a href="#photos_music" class="sub_car_pane navbar-nav-link" data-toggle="tab"> <i class="icon-users4 mr-2"></i> Photos and Favorite Music </a> </li>
                    </ul>
                  </div>
                </div>
                <div class="card card-body border-top-0 rounded-0 rounded-bottom tab-content" >
                  <div class="tab-pane fade active show" id="client_bio">
                  ...
                  <div class="tab-pane fade" id="diet_and_allergies">
                  ...
                  <div class="tab-pane fade" id="client_vitals">
                  ...
                  <div class="tab-pane fade" id="photos_music">
